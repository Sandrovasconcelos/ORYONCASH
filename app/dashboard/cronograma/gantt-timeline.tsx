...
export function GanttTimeline({ fases }: { fases: Fase[] }) {
              ...
              <details key={fase.id} className="group">
                <summary className="flex cursor-pointer list-none items-center gap-3 py-1">
                  ...
                  <span className="relative h-6 flex-1 rounded-full bg-brand-gray-100">
                    ...
                    >
                      <span
                        className="absolute inset-y-0 left-0 rounded-full bg-[color:var(--status-success)]"
                        style={{ width: `${percentual}%` }}
                      />
                    </span>
                  </span>
                  <span className="w-12 shrink-0 text-right text-xs font-extrabold text-brand-black">
                    {percentual}%
                  </span>
                </summary>
